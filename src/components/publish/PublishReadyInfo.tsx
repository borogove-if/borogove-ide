...
export const PublishReadyInfoElement: React.FC<PublishReadyInfoElementProps> = ({ publicationURL }) => <section>
    <Title>
        Ready to Publish
    </Title>
    ...
    <p>
        <Button href={publicationURL}>
            Continue to Borogove.io
        </Button>
    </p>
...
const PublishReadyInfo: React.FC = observer( () => {
    return <PublishReadyInfoElement publicationURL={publishingStore.uploadURL} />;
});
