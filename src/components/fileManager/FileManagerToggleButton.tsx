...
export const FileManagerToggleButtonElement: React.FC<FileManagerToggleButtonElementProps> = observer( ({ onClick }) =>
    <Button id="file-manager-toggle" isColor="text" onClick={onClick}><TiFolder /></Button> );
