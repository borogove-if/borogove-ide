...
export const DeleteFileModalElement: React.FC<DeleteFileModalElementProps> = observer( ({ isFolder, name, onConfirm }) => {
    ...
    return <ModalTemplate buttons={buttons} header={`Delete ${isFolder ? "folder" : "file"}`}>
...
const DeleteFileModal: React.FC<DeleteFileModalProps> = observer( ({ file }) => {
    ...
    return <DeleteFileModalElement isFolder={isFolder} name={name} onConfirm={onConfirm} />;
});
