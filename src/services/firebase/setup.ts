...
export const getPublishingFirebaseApp = (): FirebaseApp => getApp( PUBLISHING_FIREBASE_APP_ID );
export const getSnippetsFirebaseApp = (): FirebaseApp => getApp( SNIPPETS_FIREBASE_APP_ID );
