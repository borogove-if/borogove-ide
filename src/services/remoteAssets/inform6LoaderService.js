 ...
 * This loader has been generated with the following command:
       ...
       docker run --rm -v $(pwd):/tmp \
           ...
           emcc *.c -o compiler.js -Oz -g1 \
           -s FORCE_FILESYSTEM=1 -s MODULARIZE=1 \
           -s INVOKE_RUN=1 -s EXIT_RUNTIME=1
 
 * Additions to the generated file are marked with ADDED comments.
 */
...
return (
    ...
    var DYNAMIC_BASE = 5447424, DYNAMICTOP_PTR = 204352;
    ...
    var ___tm_current = 204384;

    var ___tm_timezone = (stringToUTF8("GMT", 204432, 4), 204432);
